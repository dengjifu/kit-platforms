...
//            })) {
                ...
                Namespace ns = new NamespaceBuilder().withNewMetadata().withName("thisisatest22").addToLabels("this", "rocks").endMetadata().build();
              //  log("Created namespace", client.namespaces().create(ns)+"333");
              System.out.println( client.namespaces().create(ns)+"333");
...
//                log("Root paths:", client.rootPaths());
            ...
            System.out.println(e.getMessage()+333);
            //logger.error(e.getMessage(), e);
        } finally {
